...
void MainWindow::createActions()
{
    ...
    deleteAction->setStatusTip(tr("Delete existing items"));
    connect(deleteAction,SIGNAL(triggered()),this,SLOT(deleteItems()));
}

void MainWindow::deleteItems(){
    QString name= MainWindow::getUserName();
    qDebug()<<name;
...
void MainWindow::createToolBars()
{
    ...
    commandBar = addToolBar(tr("Commands"));
    commandBar->addAction(loginAction);
    commandBar->addAction(logoutAction);
    commandBar->addAction(deleteAction);
}
...
void MainWindow::createDockWindows()
{
    ...
    // Create MessageList
    messages = new MessageList(dock);
    dock->setWidget(messages);
